class ReportGeneratorModule extends AbstractFormController
  template: _.template($("#ReportGeneratorView").html())
  
  events:
    "click .bv_generateReport": "handleGenerateReport"
    "change .bv_reportType": "handleReportTypeChange"
...
exports.ReportGeneratorModule = ReportGeneratorModule 